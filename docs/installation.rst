...
To install PIC-SURE HPDS Python Client, run this command in your terminal:
...
The sources for PIC-SURE HPDS Python Client can be downloaded from the `Github repo`_.
